...
The application is running on (https://ali-hachemi.shinyapps.io/shiny/)

ui.R, and Server.R Code in my github repository
(https://github.com/Hachemi-CRSTRA/Course-Project-Shiny-Application-and-Reproducible-Pitch)
